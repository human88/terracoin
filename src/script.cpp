...
bool IsCanonicalSignature(const valtype &vchSig) {
    // See https://terracointalk.org/index.php?topic=8392.msg127623#msg127623
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Terracoin address tx, sender provides hash of pubkey, receiver provides signature and pubkey
